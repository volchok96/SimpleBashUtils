...
Разработка набора утилит Bash для работы с текстом, включая cat и grep.
...
3. [Реализация функций](#реализация-функций)
   - [Часть 1: Работа с утилитой cat](#часть-1-работа-с-утилитой-cat)
   - [Часть 2: Работа с утилитой grep](#часть-2-работа-с-утилитой-grep)
   - [Часть 3: Дополнительно - флаги утилиты grep](#часть-3-дополнительно-флаги-утилиты-grep)
   - [Часть 4: Дополнительно - комбинации флагов утилиты grep](#часть-4-дополнительно-комбинации-флагов-утилиты-grep)

## Введение

В этом проекте вы будете разрабатывать утилиты для работы с текстом, моделируя поведение стандартных Unix-утилит cat и grep. Это задание позволит вам углубиться в использование регулярных выражений и потоковой обработки данных.

## Общая информация

Утилиты cat и grep являются фундаментальными инструментами в Unix и Linux для работы с текстом:
- **cat** используется для вывода содержимого файлов,
- **grep** применяется для поиска по паттернам.

### Основные функции

- Воспроизведение функциональности cat и grep с расширенными возможностями.
- Поддержка множества флагов для управления поведением утилит.

## Реализация функций

### Часть 1: Работа с утилитой cat

Разработайте утилиту cat, которая поддерживает основные функции и флаги GNU версий.

### Часть 2: Работа с утилитой grep

Разработайте утилиту grep с поддержкой базовых и расширенных флагов для улучшенной обработки текстовых данных.

### Часть 3: Дополнительно - флаги утилиты grep

Реализуйте дополнительные флаги для утилиты grep, позволяющие более гибко управлять поиском данных.

### Часть 4: Дополнительно - комбинации флагов утилиты grep

Разработайте поддержку комбинаций флагов для утилиты grep, что позволит еще более точно настраивать поиск.

## Сборка и тестирование

Для сборки и тестирования проекта используйте Makefile:

```bash
make build  # компиляция всех утилит
